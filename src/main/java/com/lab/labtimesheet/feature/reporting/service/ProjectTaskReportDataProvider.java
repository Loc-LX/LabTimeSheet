 ...
 * viewer is the owning Mentor, the current Leader, or a member of the Project before any
 * rows are returned; Admin viewers have no operational report scope. The Task feature owns the work-log query that supplies per-Task and per-member
...
public interface ProjectTaskReportDataProvider {
     ...
     * @param viewerIsAdmin whether the viewer is a global Admin; Admin viewers are rejected
