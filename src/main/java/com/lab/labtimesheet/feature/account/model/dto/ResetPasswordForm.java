...
/**
 * Validated password-reset submission. Password fields remain request-local and are never repopulated by the view.
 */
@Getter
@Setter
public class ResetPasswordForm {
    @NotBlank(message = "This reset link is invalid or no longer usable")
