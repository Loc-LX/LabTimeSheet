...
| Architecture steps 5–7 | Step 5 is part A of the platform plan, drafted on 22 September 2026 with its tasks | Maintainer approves part A; then the documentation branch merges into `main` with permission, and step 6 builds it |
