...
| Architecture steps 5–7 | Step 5 is done. Step 6 tasks A-01 through A-11 are complete on `work/fix/architecture/module-boundaries`. | A-12 closes step 6. Step 6 branched from `2945975` ahead of PR #14 merge per maintainer directive. |
