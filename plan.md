...
`PLAN.md` and one `TASKS.md` per module, divided into parts. `D40` replaced that on 23 September
2026: plans sit beside feature SPECs, and part A moves to the Architecture feature after `A-12`.
