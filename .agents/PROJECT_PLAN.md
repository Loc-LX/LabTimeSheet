...
| ID | Deliverable | Test/evidence emphasis | Status | Owner/date | Result/commit |
|---|---|---|---|---|---|
| I4-PLAT-01 | Add nullable whole-Task estimates and append-only Remaining effort forecast persistence. | Fresh PostgreSQL 18.4 Flyway replay and catalog assertions for checks, same-Project FKs, supersession shape, indexes, and no backfill. | `DONE` | GPT-5.6 Luna Max / 2026-08-26 | Focused `PlatformFoundationTest#flywayCreatesApprovedPostgresCatalog` passed against PostgreSQL 18.4 with Flyway v2; commit `ab626fe`; evidence `docs/tests/integration/task-effort-planning-catalog.md`. |
| I4-TSK-01 | Add estimate, lifetime actual, and DONE-only variance behavior. | Task application seam, authorization, first-log locking, and hand-derived variance scenarios. | `DONE` | GPT-5.6 Luna Max / 2026-08-26 | Packet-2 result at commit `83dd924`; evidence `docs/tests/integration/task-estimate-effort-variance.md`; current PostgreSQL 18.4 TaskCreationIntegrationTest rerun passed 35/35. The later Packet-3A1 changes are not attributed to `83dd924`. |
| I4-TSK-02 | Add forecast-aware reassignment/correction and direct-removal guard. | Manual/batch/redistribution atomicity, provenance, stale/concurrent correction, and non-mutation denial. | `DONE` | GPT-5.6 Luna Max / 2026-08-27 | Root review accepted immutable head `dd265a3ea64c1094e13ba6ddb2bec8667b22e5972c6c22ea3de65ac51a13850b` after implementation and review-fix commits `0dc08ee`, `ed5fe01`, `43aa45b`, and `6801d07`. Root reruns passed the focused public-boundary gate 101/101 and PostgreSQL 18.4 affected gate 99/99; `git diff --check` is clean. Evidence: `docs/tests/integration/task-remaining-effort-forecast.md` and `docs/tests/integration/task-remaining-effort-forecast-correction.md`. |
| I4-UI-01 | Add authorized Daily Project Work Report dataset and HTML presentation. | Mentor/Admin scope, historical retained logs, current status, empty states, date/calendar semantics. | `DONE` | GPT-5.6 Luna Max / 2026-08-27 | Root review accepted commit `b70ce241ab85917aae9395ac4ab17e29703d22dac6f0b9ef1bf75710edad4ba4`. Focused gate passed 20/20; affected PostgreSQL 18.4 gate passed 49/49; compile, Javadoc/doclint, and frontend build passed. Full Maven ran 684 tests with the authorized independent baseline envelope unchanged at 5 failures/21 errors and no new failure family. Node UI remained at 17/20 with three unchanged CRLF-sensitive baseline failures. Evidence: `docs/tests/integration/daily-project-work-report.md` and `docs/tests/web/daily-project-work-report.md`. |
| I4-UI-02 | Add XLSX/PDF Daily export parity and final evidence. | Shared dataset, numeric minutes, Unicode PDF, deterministic filenames, parser-level parity. | `DONE` | GPT-5.6 Luna Max / 2026-08-27 | Root review accepted commit `4870889415183380a92a03991b94afb62427a6ca6e186e4514391ec1d793f64d`. Root focused rerun passed 32/32; affected PostgreSQL 18.4/Flyway v2 gate passed 77/77; architecture, compile, Javadoc/doclint, and frontend build passed. The frozen broad run executed 696 tests with the known 5-failure/21-error baseline plus one new Daily print wrapper failure; the wrapper was corrected and its targeted 25-case envelope returned to only the pre-existing `reports/print.html` failure. XLSX retains numeric minutes and visibly signed numeric DONE variance; PDF parser evidence proves embedded-font Vietnamese hierarchy and labeled totals. Evidence: `docs/tests/web/daily-project-work-report-exports.md`. |
| I4-UI-03 | Supersede Daily-report authorization with Q31-R Mentor/current-Leader scope across HTML, XLSX, and PDF, then remove the dedicated report scope from Admin. | Mentor all-or-selected owned Projects; current-Leader exact mandatory currently-led PLANNED/ACTIVE Project via Project detail or server-derived conditional Daily navigation; non-current-Leader roles and Project IDs denied. Admin has no Attendance, Project/Task, or Daily report navigation, dataset, or exporter scope; its dashboard remains account/configuration-only. | `DONE` | GPT-5.6 Luna Max / 2026-08-27 | Historical Q31 implementation/review commits remain `756ea6c0ed2faf9c4c53e11ee89a4c9e59ee353d4c3ff7d8b4d4997432dd14cf` and `774ee0bc452c29edb835991e335218ba24be5743aff66ca090b73329cde2f27b`; current correction commits are `17be05344ed9f815f1f53a14da978397b723eb2695c758f1908af2bb6b7f744c` (current-Leader navigation), `5b8aa5f7564a2739d7bb93ddd17c9af99ec37d79358ae39ee3525eb7ac4c2ccb` (Admin boundary/dashboard), `fe41091d0938d087ec88c995795bd3adb9fcd82e6e62434cd6bb9c93f03d1b6c` (request boundaries/navigation-advice coverage), and final b217 `b2178ba9b6abc755c9b4affb9b537c91b7a79aec8b9c688bd4beaef268ca2274` (current-Leader capability before date context). The b217 RED was genuine: an unqualified Intern with a future date previously received `400` before capability denial; `DailyProjectWorkReportControllerWebTest#unqualifiedInternIsDeniedBeforeDateContextForPastCurrentAndFutureDates` now covers past/current/future `404 Project unavailable` and verifies no Attendance date-context, full-list, or report-build interaction. Final root integrated gate on b217 passed `85/85` (DailyProjectWorkReportControllerWebTest `13`); final PostgreSQL 18.4/Testcontainers gate passed `51/51` (Attendance `46`, Project transition `1`, Admin dashboard `4`). ReportingArchitectureTest, compile, and javadoc:javadoc passed. Live localhost verification confirmed Admin configuration-only dashboard/sidebar and report denial, current-Leader one-Project landing, ordinary Intern/Mentor navigation, and 1440x900/390x844 no-overflow observations; keyboard traversal, live multi-Project selector, actual download payloads, and clean broad Maven remain unverified. Root `npm.cmd run test:ui` passed `17/20`, with three unchanged CRLF-only delivery-contract failures. No push or merge. |
