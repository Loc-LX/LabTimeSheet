...
| I4-UI-03 | Supersede Daily-report authorization with Q31-R Mentor/current-Leader scope across HTML, XLSX, and PDF. | Mentor all-or-selected owned Projects; current-Leader exact mandatory currently-led PLANNED/ACTIVE Project via Project detail; non-current-Leader roles and Project IDs denied. | `DONE` | GPT-5.6 Luna Max / 2026-08-27 | Implementation commit `756ea6c0ed2faf9c4c53e11ee89a4c9e59ee353d4c3ff7d8b4d4997432dd14cf`; review-fix/current head `774ee0bc452c29edb835991e335218ba24be5743aff66ca090b73329cde2f27b`. Current Leader HTML/XLSX/PDF is one exact mandatory currently-led PLANNED/ACTIVE Project entered from Project detail; Admin, ordinary Intern, former Leader, other-Project Leader, completed Project, missing `projectId`, and guessed IDs are denied. Focused Q31-R service/controller/export gate passed 62/62; malformed-leadership producer regression passed 1/1 with `Asia/Ho_Chi_Minh`; `git diff --check` reports no whitespace errors (Windows line-ending warnings only). Local evidence remains at ignored `.superpowers/sdd/q31-r-daily-report/task-1-report.md`; it is intentionally absent from the product diff. No push or merge. |
