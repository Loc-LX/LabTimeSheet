...
| [Cancel or delete](#cancel-or-delete) | Owning Mentor deletes only an empty draft or cancels with retained work and reason | [PRJ-002](SPEC.md), [PRJ-023](SPEC.md), [DB-019](SPEC.md) | [AC-PRJ-014](SPEC.md), [AC-PRJ-015](SPEC.md), [AC-DB-007](../../MODULE.md) | `D35` settles internship readiness through ACC-022 and AC-ACC-018; cancellation itself still preserves every Task status and history. |
