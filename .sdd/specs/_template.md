...
**Version:** 0.1 (DRAFT) · **Owner:** @name · **Status:** DRAFT · **Date:** YYYY-MM-DD

Copy this file to `.sdd/specs/feature-<name>/SPEC.md` for a new feature, and add a
`CHANGELOG.md` beside it. A rule lives in exactly one spec (`GOV-016`); another spec
that needs it points to it instead of restating it.
